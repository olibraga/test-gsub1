...
import name.olibraga.testgsub1.config.audit.AuditEventConverter;
import name.olibraga.testgsub1.domain.PersistentAuditEvent;
...
import static name.olibraga.testgsub1.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
