...
import name.olibraga.testgsub1.TestGsub1App;
import name.olibraga.testgsub1.config.Constants;
import name.olibraga.testgsub1.domain.Authority;
import name.olibraga.testgsub1.domain.PersistentToken;
import name.olibraga.testgsub1.domain.User;
import name.olibraga.testgsub1.repository.AuthorityRepository;
import name.olibraga.testgsub1.repository.PersistentTokenRepository;
import name.olibraga.testgsub1.repository.UserRepository;
import name.olibraga.testgsub1.security.AuthoritiesConstants;
import name.olibraga.testgsub1.service.MailService;
import name.olibraga.testgsub1.service.UserService;
import name.olibraga.testgsub1.service.dto.PasswordChangeDTO;
import name.olibraga.testgsub1.service.dto.UserDTO;
import name.olibraga.testgsub1.web.rest.errors.ExceptionTranslator;
import name.olibraga.testgsub1.web.rest.vm.KeyAndPasswordVM;
import name.olibraga.testgsub1.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = TestGsub1App.class)
